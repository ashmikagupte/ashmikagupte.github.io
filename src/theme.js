...
export const customTheme = {
  body: "#0E0E0E",          // Cosmic Black
  text: "#FFFFFF",           // Starlight White
  expTxtColor: "#808080",    // Nebula Gray
  highlight: "#9370DB",      // Solar Flare Yellow
  dark: "#000000",           // Black Hole Black
  secondaryText: "#A0A0A0",  // Stellar Gray
  imageHighlight: "#0A77F4", // Deep Space Blue
  compImgHighlight: "#555555",// Steel Gray
  jacketColor: "#C0504D",    // Red Planet Red
  headerColor: "#1A1A1A",    // Dark Space Gray
  splashBg: "#04040E" 
};
